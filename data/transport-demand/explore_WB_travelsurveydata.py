...
# import stata file
df = pd.read_stata('C:/Users/86138/Desktop/Kenya project/WB_travelsurvey.dta')

# transport Qs are mode to work and time to work

main_mode_cols = ['age_1','age_2','age_3','age_4','age_5','age_6','age_7','age_8','age_9','age_10','age_11','age_12','age_13','age_14','age_15',
                  'q14d_1','q14d_2','q14d_3','q14d_4','q14d_5','q14d_6','q14d_7','q14d_8','q14d_9','q14d_10','q14d_11','q14d_12','q14d_13','q14d_14','q14d_15',
...
for mode in tripdistance2:
    for e in range (1,16):
        tripdistance2[mode] += df.loc[(df[f'q14l_{e}'] == mode) & (df[f'tripdist_{e}'] > 1) & (df[f'tripdist_{e}'] <= 2), f'tripdist_{e}'].sum()
print(tripdistance2)
...
for mode in tripdistance3:
    for e in range (1,16):
        tripdistance3[mode] += df.loc[(df[f'q14l_{e}'] == mode) & (df[f'tripdist_{e}'] > 2) & (df[f'tripdist_{e}'] <= 5), f'tripdist_{e}'].sum()
print(tripdistance3)
...
for mode in tripdistance4:
    for e in range (1,16):
        tripdistance4[mode] += df.loc[(df[f'q14l_{e}'] == mode) & (df[f'tripdist_{e}'] > 5) & (df[f'tripdist_{e}'] <= 10), f'tripdist_{e}'].sum()
...
for mode in tripdistance5:
    for e in range (1,16):
        tripdistance5[mode] += df.loc[(df[f'q14l_{e}'] == mode) & (df[f'tripdist_{e}'] > 10) & (df[f'tripdist_{e}'] <= 25), f'tripdist_{e}'].sum()
...
for mode in tripdistance6:
    for e in range (1,16):
        tripdistance6[mode] += df.loc[(df[f'q14l_{e}'] == mode) & (df[f'tripdist_{e}'] > 25) & (df[f'tripdist_{e}'] <= 50), f'tripdist_{e}'].sum()
...
for mode in tripdistance7:
    for e in range (1,16):
        tripdistance7[mode] += df.loc[(df[f'q14l_{e}'] == mode) & (df[f'tripdist_{e}'] > 50) & (df[f'tripdist_{e}'] <= 100), f'tripdist_{e}'].sum()
